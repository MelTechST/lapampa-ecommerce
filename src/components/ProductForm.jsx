...
function ProductForm({ onSubmit, productoEditar, onCancel }) {
    ...
    const validar = () => {
        ...
        if (!nombre.trim()) {
            erroresValidacion.push ('El nombre no puede estar vecío.');
        }
        if (precio === '' || isNaN(precio) || Number(precio) <= 0) {
            erroresValidacion.push('El precio debe ser un número a 0.');
        }
    ...
    return (
        <Form onSubmit={handleSubmit}>
            ...
            <Form.Group as={Row} className="mb-3" controlId="precio">
                ...
                <Col sm={10}>
                <Form.Control type="number" placeholder="Precio" value={precio} onChange={(e) => setPrecio(e.target.value)} min="0" step="0.01"/>
                </Col>
            </Form.Group>
