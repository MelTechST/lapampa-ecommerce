                    ...
                    <Container className="p-3">
                        ...
                        <Form className="p-4 me-auto" >
                            ...
                            <Form.Group className="p-3 m-1" style={{ width: "400px" }}>
                                ...
                                <Form.Control type="text" placeholder="Ingrese un asunto del mensaje"/>
                            </Form.Group>
                            <Form.Group className="p-3 m-1" style={{ width: "400px" }}>
                                <Form.Label>Mensaje:</Form.Label>
                                <Form.Control as="textarea" rows={3} placeholder="Escriba un mensaje"/>
                            </Form.Group>
                            <Button variant="primary" className="mt-2"  style={{ width: "400px" }}>
                                Enviar
                            </Button>
                        </Form>
                    </Container>
